...
st.set_page_config(
     page_title="Demo Pending Reports",
 )

#Gather the most recent 'As Of' and 'Load' dates for each section
common_df = get_spreadsheet_data("Demo_Common_Table", credentials)
    ...
    if submitted and len(file_objects) > 0:
        ...
        for report in report_list:
            ...
            if report_meets_requirements == True:
                ...
                DEMO_pending_upload.update_spreadsheet(report['Report Type'], report['Content'])
            else:
